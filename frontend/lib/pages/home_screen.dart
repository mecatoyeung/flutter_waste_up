...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Job> visibleJobs(AppLocalizations l10n) {
    ...
    final jobs = [
      Job(
        'communityGarden',
        l10n.communityGardenAssistant,
        l10n.greenRootsCollective,
        l10n.riversideLocation,
        l10n.partTime,
        l10n.pay14,
        Icons.spa_outlined,
        const Color(0xFFD9EAC9),
      ),
      Job(
        'recyclingSorter',
        l10n.recyclingSorter,
        l10n.secondCycle,
        l10n.centralDistrictLocation,
        l10n.flexibleShifts,
        l10n.pay16,
        Icons.recycling_outlined,
        const Color(0xFFCBE5E3),
      ),
      Job(
        'kitchenSupport',
        l10n.kitchenSupportWorker,
        l10n.goodTable,
        l10n.marketSquareLocation,
        l10n.fullTime,
        l10n.pay15,
        Icons.soup_kitchen_outlined,
        const Color(0xFFF8DEB1),
      ),
    ];
    ...
    return jobs
        .where(
          (job) =>
              ...
              job.organisation.toLowerCase().contains(term),
        )
        .toList();
  }
          ...
          children: [
            ...
            Row(
              children: [
                OutlinedButton.icon(
                  ...
                  icon: Icon(
                    showNearby ? Icons.check : Icons.near_me_outlined,
                    size: 18,
                  ),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => message(l10n.showingAll),
  ...
  ButtonStyle outlinedStyle(Color background, Color border) =>
            ...
            SizedBox(
              ...
              child: FilledButton(
                onPressed: () {
                  ...
                  message(
                    AppLocalizations.of(context)!.applicationStarted(job.title),
                  );
                },
        ...
        child: Row(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 6,
                    children: [Tag(job.type), Tag(job.pay)],
                  ),
            ...
            IconButton(
              onPressed: onSave,
              tooltip: isSaved
                  ? AppLocalizations.of(context)!.removeSavedJob
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              Text(
                AppLocalizations.of(context)!.impactDescription,
        ...
        child: Column(
          ...
          children: [
            ...
            const LinearProgressIndicator(
              ...
              minHeight: 9,
              color: yellow,
              backgroundColor: Color(0xFFE7E9E4),
              borderRadius: BorderRadius.zero,
            ),
            const SizedBox(height: 12),
            Text(l10n.availabilityPrompt, style: const TextStyle(color: muted)),
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(l10n.tryDifferentSearch, style: const TextStyle(color: muted)),
        ],
      ),
    );
  }
